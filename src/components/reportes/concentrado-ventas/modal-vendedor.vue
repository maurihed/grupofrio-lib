...
export default {
  ...
  computed: {
    ...
    puntosEfectividad() {
      ...
      return Number(puntos > this.puntos.Efectividad ? this.puntos.Efectividad : puntos);
    },
    puntosKilosVendidos() {
    ...
    puntosCombustible() {
      ...
      const puntos = Math.round(eficiencia * 100, 2) / 100;
      return Number(puntos > this.puntos.Combustible ? this.puntos.Combustible : puntos);
    },
